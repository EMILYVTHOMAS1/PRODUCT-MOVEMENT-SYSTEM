<%@ Page Title="" Language="C#" MasterPageFile="~/Company.master" AutoEventWireup="true" CodeFile="companypurchaserequest.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" 
        ...
        style="z-index: 1; left: 16px; top: 82px; position: absolute; height: 390px; width: 785px">
    ...
    style="z-index: 1; left: 353px; top: 11px; position: absolute" Text="SALE REQUEST"></asp:Label>
        ...
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" 
                ...
                Width="125px" AutoGenerateRows="False" DataKeyNames="Pname" DataSourceID="SqlDataSource1" 
                >
                <Fields>
