<%@ Page Title="" Language="C#" MasterPageFile="~/guest.master" AutoEventWireup="true" CodeFile="ClientLogin.aspx.cs" Inherits="Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" 
        ...
        <asp:Label ID="Label1" runat="server" Text="CLIENT LOGIN" 
