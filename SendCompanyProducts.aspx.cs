...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     cmpID  = Session["cmpID "].ToString();
        ...
        s = "select * from request a ,response b where a.cmpID= '" + cmpID  + "' and a.reqno=b.reqno and b.respstatus='Y' and b.sendmode is null  and a.reqmode ='B' " ;
