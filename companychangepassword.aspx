<%@ Page Title="" Language="C#" MasterPageFile="~/Company.master" AutoEventWireup="true" CodeFile="companychangepassword.aspx.cs" Inherits="Default3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" 
        style="z-index: 1; left: 283px; top: 173px; position: absolute; height: 396px; width: 826px">
        <asp:Label ID="Label1" runat="server" 
            style="z-index: 1; left: 270px; top: 31px; position: absolute; width: 300px;" 
            Text="COMPANY CHANGE PASSWORD"></asp:Label>
