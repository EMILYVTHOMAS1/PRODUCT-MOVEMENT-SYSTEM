<%@ Page Title="" Language="C#" MasterPageFile="~/Staff.master" AutoEventWireup="true" CodeFile="clientapproval1.aspx.cs" Inherits="Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [ClientID], [Cname], [Place], [State] FROM [clientreg]"></asp:SqlDataSource>
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:RadioButton ID="RadioButton1" runat="server" Checked="True" GroupName="x" 
                style="z-index: 1; left: 328px; top: 86px; position: absolute; width: 78px" 
                Text="yes" />
        </asp:Panel>
</asp:Panel>
</asp:Content>
