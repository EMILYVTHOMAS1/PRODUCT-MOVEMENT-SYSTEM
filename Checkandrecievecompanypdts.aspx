<%@ Page Title="" Language="C#" MasterPageFile="~/Staff.master" AutoEventWireup="true" CodeFile="Checkandrecievecompanypdts.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    style="z-index: 1; left: 222px; top: 25px; position: absolute; width: 472px;" 
        Text="CHECK AND RECEIVE PRODUCTS FROM COMPANY"></asp:Label>
        ...
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:productdataConnectionString %>" 
                SelectCommand="SELECT [cmpID], [cmpname], [Address], [Place], [Pin], [Phone], [Email], [State], [Country], [Accountno], [currency], [Bname] FROM [companyreg]">
            </asp:SqlDataSource>
            <asp:RadioButton ID="RadioButton2" runat="server" GroupName="x" 
                
                style="z-index: 1; left: 500px; top: 43px; position: absolute; width: 20px;" Text="No" 
            ...
            <asp:Panel ID="Panel3" runat="server" 
                ...
                <asp:Button ID="Button2" runat="server" onclick="Button2_Click" 
                    style="z-index: 1; left: 118px; top: 128px; position: absolute; height: 26px; width: 50px;" 
                    Text="Reset" />
            </asp:Panel>
