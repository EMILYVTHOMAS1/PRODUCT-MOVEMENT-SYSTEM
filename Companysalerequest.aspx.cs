...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            s = "select * from companyproducts where cmpID = '" + cmpID + "' and ImpexpStatus ='import' ";
            dr = a1.disp(s);
            while (dr.Read())
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        s = "insert into Request(Reqno,Pname,Qty,cmpID,ReqDate,Reqmode) values (" + Reqno.ToString() + ",'" + DropDownList1.Text + "','" + TextBox1.Text + "','" + cmpID + "','" + ReqDate + "','B') ";
        a1.insert(s);
