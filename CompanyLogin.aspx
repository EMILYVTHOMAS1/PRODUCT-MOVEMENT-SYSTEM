<%@ Page Title="" Language="C#" MasterPageFile="~/guest.master" AutoEventWireup="true" CodeFile="CompanyLogin.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" 
        ...
        <asp:Label ID="Label1" runat="server" Text="COMPANY LOGIN" 
            
            
            style="z-index: 1; left: 242px; top: 30px; position: absolute; width: 181px; height: 20px"></asp:Label>
