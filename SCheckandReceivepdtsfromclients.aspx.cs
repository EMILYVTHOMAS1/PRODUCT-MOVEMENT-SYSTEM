...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            string s;
            s = "select * from request a,response b where a.reqno=b.reqno and b.respstatus='Y' and b.sendmode is not null and a.reqno not in(select reqno from chreceive) and a.reqmode='A' ";
