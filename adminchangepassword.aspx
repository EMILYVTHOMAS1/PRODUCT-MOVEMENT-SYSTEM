<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="adminchangepassword.aspx.cs" Inherits="Default3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" 
        style="z-index: 1; left: 240px; top: 147px; position: absolute; height: 396px; width: 826px">
        <asp:Label ID="Label1" runat="server" 
            style="z-index: 1; left: 270px; top: 31px; position: absolute; width: 300px;"> ADMIN CHANGE PASSWORD</asp:Label>
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" 
            ...
            ErrorMessage="Incorrect Password" ForeColor="Red" 
            style="z-index: 1; left: 583px; top: 197px; position: absolute; width: 157px"></asp:CompareValidator>
        <asp:Label ID="Label5" runat="server" 
            style="z-index: 1; left: 453px; top: 248px; position: absolute; width: 76px"></asp:Label>
    </asp:Panel>
</asp:Content>
